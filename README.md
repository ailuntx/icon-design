...
此版本沿用 Color Sail 图标，并补全图片 API 路线的询问步骤。[在插件目录安装 Icon Design](https://chatgpt.com/plugins/plugins_6ab4afd6b1188191a10f9cd382d2f196)。旧版 AI Icon Studio 已从公开目录下架。
